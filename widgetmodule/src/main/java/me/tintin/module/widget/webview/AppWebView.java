...
public class AppWebView extends WebView
{
    ...
    // JS发起请求的关键key
    public static final String JS_OACTION_HEAD = "onAction";
    ...
    private void initWebViewSetting()
    {
        ...
        // String dir = getActivity().getApplicationContext().getDir("database",
        ...
        setWebViewClient(new WebViewClient()
        {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url)
            {
                ...
                {
                    // 防止crash,如果手机上没有安装 某个 scheme开头的url的app,会导致cr
                    return false;
                }
                return true;
