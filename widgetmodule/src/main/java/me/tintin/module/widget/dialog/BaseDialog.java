package me.tintin.module.widget.dialog;
...
public abstract class BaseDialog extends Dialog
{
    ...
    /**
     * DIALOG_TYPE_INSIDE 如果dialog的样式设置为此最大的时候，setCanceledOnTouchOutside这个效果是无效的
     */
     ...
     * DIALOG_TYPE_BOTTOM
     */
    public static final int DIALOG_TYPE_NO_TOLLBAR = 6;
     ...
     */
    public BaseDialog(Context context, int layoutId, int type)
    {
        super(context, R.style.BaseDialog);
        mContext = context;
        setCanceledOnTouchOutside(false);
        setCancelable(true);
        initViews(layoutId, type);
    }
    ...
    private void initViews(int layoutId, int type)
    {
        ...
        switch (type)
        {
            ...
            {
                // 注意，如果dialog的样式设置为此最大的时候，setCanceledOnTouchOutside这个效果是无效的
            ...
            {
                FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                        (int) (mWidth * 0.8), (int) (mHeight * 0.6));
                setContentView(mContainer, lp);
            }
                break;
