...
public class CustomViewAbove extends ViewGroup
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        final int contentHeight = getChildMeasureSpec(heightMeasureSpec,
                0,
                height);
    ...
    private void completeScroll()
    {
        ...
        if (needPopulate)
        {
            // Done with scroll, no longer want to cache me.tintin.module.zxing.zxinglibrary.view drawing.
            setScrollingCacheEnabled(false);
            //终止动画效果
     ...
     * @param checkV Whether the me.tintin.module.zxing.zxinglibrary.view v passed should itself be checked for scrollability (true),
    ...
    {
        // Let the focused me.tintin.module.zxing.zxinglibrary.view and/or our descendants get the key first
